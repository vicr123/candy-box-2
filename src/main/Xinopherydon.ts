...
export class Xinopherydon extends QuestEntity{
    ...
    public willDie(): void{
        ...
        // The claw
        this.getQuest().foundGridOrEqItem(new QuestItemFound(this.getQuest(), "apXinopherydonClaw", `You found ${itemName(this.getQuest().itemScoutResults.findItem("XINOPHERYDON_CLAW_ACQUIRED"))}.`, this.getQuest().itemScoutResults.findItem("XINOPHERYDON_CLAW_ACQUIRED")));
    }
}