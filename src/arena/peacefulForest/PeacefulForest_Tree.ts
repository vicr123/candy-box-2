...
import {Naming} from "../../main/Naming";
import {RenderArea} from "../../main/RenderArea";
import {CollisionBoxCollection} from "../../main/CollisionBoxCollection";
import {CollisionBox} from "../../main/CollisionBox";
import {QuestEntityMovement} from "../../main/QuestEntityMovement";
import {QuestEntityWeapon} from "../../main/QuestEntityWeapon";

export class PeacefulForest_Tree extends QuestEntity{
    // Constructor
